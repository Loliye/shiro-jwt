...
public class SerializableUtil
{
    ...
    public static byte[] serializable(Object object)
    {
        ...
        } catch (IOException e)
        {
            ...
            throw new CustomExcetption("SerializableUtil工具类序列化出现IOException异常:" + e.getMessage());
        } finally
        {
            try
            {
            ...
            } catch (IOException e)
            {
                ...
                throw new CustomExcetption("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
            }
        }
    }
    ...
    public static Object unserializable(byte[] bytes)
    {
        ...
        } catch (ClassNotFoundException e)
        {
            ...
            throw new CustomExcetption("SerializableUtil工具类反序列化出现ClassNotFoundException异常:" + e.getMessage());
        } catch (IOException e)
        {
            logger.error("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
            throw new CustomExcetption("SerializableUtil工具类反序列化出现IOException异常:" + e.getMessage());
